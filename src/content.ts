...
export const imageMap = {
  heroHistory: asset('hero-history.jpg'),
  heroHouse: asset('hero-house.jpg'),
  comfort: asset('comfort.jpg'),
  security: asset('security.png'),
  durability: asset('durability.png'),
  transparency: asset('transparency.jpg'),
  livingSpaces: asset('living-spaces.jpg'),
  foodPoints: asset('food-points.jpg'),
  comparison: asset('comparison.jpg'),
  process: asset('process.jpg'),
  gallery1: asset('gallery-1.jpg'),
  gallery2: asset('gallery-2.jpeg'),
  gallery3: asset('gallery-3.jpg'),
  gallery4: asset('gallery-4.jpg'),
  gallery5: asset('gallery-5.jpg'),
  businessMiniGym: asset('business-mini-gym.jpg'),
  businessStorage: asset('business-storage.png'),
} as const;
