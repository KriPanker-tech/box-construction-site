const asset = (fileName: string) => `assets/site-copy/${fileName}`;

export const imageMap = {
  heroHistory: asset('hero-history.webp'),
  heroHouse: asset('hero-house.webp'),
  comfort: asset('comfort.webp'),
  security: asset('security.webp'),
  durability: asset('durability.webp'),
  transparency: asset('transparency.webp'),
  livingSpaces: asset('living-spaces.webp'),
  foodPoints: asset('food-points.webp'),
  comparison: asset('comparison.webp'),
  process: asset('process.webp'),
  gallery1: asset('gallery-1.webp'),
  gallery2: asset('gallery-2.webp'),
  gallery3: asset('gallery-3.webp'),
  gallery4: asset('gallery-4.webp'),
  gallery5: asset('gallery-5.webp'),
  businessMiniGym: asset('business-mini-gym.webp'),
  businessStorage: asset('business-storage.webp'),
} as const;
